    ...
    <main className=''>
        <section className='min-h-screen' >
          ...
          <div className='text-center p-10'>
            ...
            <p>Tente contato pelo WhatsApp</p><a href='https://api.whatsapp.com/send?phone=554796742664' target='_blank' className='text-5xl text-black hover:text-custom-green flex justify-center mt-6'><BsWhatsapp /></a>
